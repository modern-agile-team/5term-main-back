...
import { StudyCreateDto } from '@src/study/dtos/study.create.dto';
import { StudyService } from '@src/study/services/study.service';
...
export class StudyController {
  ...
  @ApiParam({
    name: '스터디 id',
    example: '/study-management/search/studies/2',
  })
  @Get('/search/studies/:userId')
  getUserStudy(@Param('userId', ParseIntPipe) userId: number) {
  ...
  @UseGuards(JwtAccessGuard)
  @Patch('accept')
  acceptStudy(@GetUserId() userId, @Body() req) {
